...
opt = {
   ...
   name = 'train_ucf_pred_point_10frame',
...
if opt.network == '' then
  ...
  dhi1 = nn.SpatialFullConvolution(opt.classnum, nplanes * 2 , 8, 8)(dx_C) 
  dbi1 = nn.SpatialBatchNormalization(nplanes * 2)(dhi1)
  dri1 = nn.ReLU(true)(dbi1)

  dhi1_1 = nn.SpatialFullConvolution(nplanes * 2, nplanes * 1, 4, 4, 2, 2, 1, 1)(dri1) 
  dbi1_1 = nn.SpatialBatchNormalization(nplanes * 1)(dhi1_1)
  dri1_1 = nn.ReLU(true)(dbi1_1)
  ...
  dc1 = nn.JoinTable(2, 2)({dr3, dri1_1})  -- rgb + flowxy

  dh4 = nn.SpatialConvolution(nplanes * 5, nplanes * 8, 3, 3, 2, 2, 1, 1)(dc1) -- size / 2
  ...
  c1 = nn.JoinTable(2, 2)({ x_I, x_C2 })

  hi1 = nn.SpatialFullConvolution(opt.nz + opt.classnum, nplanes * 2 , 8, 8)(c1) 
  ...
  h1 = nn.SpatialConvolution(3, nplanes, 5, 5, 2, 2, 2, 2)(x_C)  -- 64 * 64
