...
model_G = torch.load('/home/xiaolonw/ruslan/models_ucf/train_ucf_pred_point/32_net_G.t7')
...
local resultfile = '/home/xiaolonw/ruslan/results/train_ucf_pred_point.txt' 
