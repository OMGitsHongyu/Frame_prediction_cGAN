...
model_G = torch.load('/home/xiaolonw/ruslan/models_ucf/train_ucf_pred_point_10frame/32_net_G.t7')
...
local resultfile = '/home/xiaolonw/ruslan/results/train_ucf_pred_point_10frame.txt' 
...
function getSamples(dataset, N, beg)
  ...
  batch_data = makeData_video(trainLoader:get(beg + 1, beg + N ))
  ...
  batch_error = batch_error / N
  error_sum   = error_sum + batch_error
  print(batch_error)
