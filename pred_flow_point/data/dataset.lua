...
list_file = '../testlist_gap5_cluster.txt'
-- list_file = '../testlist_gap10_cluster.txt'
...
function dataset:getByClass(class)
   ...
   return self:sampleHookTrain(imgpath, lblpath, lblnum ) -- change to label iame path--  lblnum) 
end


-- converts a table of samples (and corresponding labels) to a clean tensor
local function tableToOutput(self, dataTable, nowlbls, nowlblnums)
...
function dataset:sample(quantity)
   ...
   for i=1,quantity do
      local img, lblnum, lblidx = self:getByClass(i)
