...
if opt.network == '' then
  ...
  h2_2 = nn.SpatialConvolution(nplanes * 2, nplanes * 4, 3, 3, 1, 1, 1, 1)(r2)  -- 16 * 16 
...
local fDx = function(x)
   ...
   cond_inputs_coarse:copy(inputs_all[5])
   ...
   cond_inputs_coarse:copy(inputs_all2[5])
...
--       paths.mkdir('/nfs.yoda/xiaolonw/torch_projects/models_coco/' .. opt.name .. '/')
       paths.mkdir('/scratch/hongyuz/models_coco/' .. opt.name .. '/')
