...
model_G = torch.load('/scratch/hongyuz/models_coco5/train_coco_res_dcgan_ori64_sr_ori/40_net_G.t7')
...
local resultfile = '/scratch/hongyuz/models_coco5/train_coco_res_dcgan_ori64_sr_ori/res_cls.txt' 
local file = torch.DiskFile(resultfile, "w")


function getSamples(dataset, N, beg)
  local resultpath = '/scratch/hongyuz/models_coco5/train_coco_res_dcgan_ori64_sr_ori/'
  ...
  for i=1,N do
      ...
      coarse_img = (cond_inputs[i] + 1 ) * opt.div_num
