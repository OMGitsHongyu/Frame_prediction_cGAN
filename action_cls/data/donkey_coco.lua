...
function makeData_video_flow(fine, flowx, flowy, labels)
   ...
   opt.flag  = 0
   return {labels,  coarse_input0, flow_input} 
end
...
local trainHook = function(self, imgpath, flowxpath, flowypath, lblnum)
   collectgarbage()
