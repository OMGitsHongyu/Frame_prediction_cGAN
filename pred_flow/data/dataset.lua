...
list_file = '../train_genlist_all_img_1frame_reverse_train_flow.txt'
-- lbl_list_file = '../label_all_img.txt'
-- path_dataset = '/scratch/hongyuz/gen_imgs_all3/'
path_dataset = '/scratch/xiaolonw/'
...
function dataset:getByClass(class)
   ...
   return self:sampleHookTrain(imgpath, lblpath, flowxpath, flowypath ) -- change to label iame path--  lblnum) 
end


-- converts a table of samples (and corresponding labels) to a clean tensor
local function tableToOutput(self, dataTable, nowlbls, nowflowx, nowflowy)
...
function dataset:sample(quantity)
   ...
   for i=1,quantity do
      local img, lblnum, flowx, flowy = self:getByClass(i)
