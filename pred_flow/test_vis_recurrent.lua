...
model_G = torch.load('/home/xiaolonw/ruslan/models_ucf/train_ucf_pred_10frame/40_net_G.t7')
...
function getSamples(dataset, N, beg)
  ...
  for t = 1 , recurrent_len do
    ...
    for i=1,N do
      output_name = paths.concat(resultpath, string.format('%04d_%04d_pred.jpg',i + beg, t))
      output_img = samples[i]:float():clone()
